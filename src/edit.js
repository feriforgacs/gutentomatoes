	...
	return (
		<div className={ className }>
			...
			{ isLoading && (
				...
				>
					<Spinner />
					<p>{ __( 'Getting data from Rotten Tomatoes...', 'gutentomatoes' ) }</p>
				</Placeholder>
			)}
			...
			{ ( isSelected || ! attributes.movieURL ) && ! attributes.moviePoster && ! isLoading && (
					<Placeholder
						icon={ icon }
					...
					>
						...
						>
							{ embedError && (
								<p className='gutentomato-movie__error-message'>{ embedError }</p>
							)}
							<TextControl
